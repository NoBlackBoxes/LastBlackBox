...
- However, to make websites interactive, the world needed a "scripting language" that ran in the web browser, which could respond to user clicks and events (and much more).
- For example, when you click a "Buy Now" button on a website, some Javascript code runs in the browser to make your purchase actually happen.

...
duration = 2.0
frequency = 440.0
tone = Utilities.generate_pure_tone(duration, frequency, sample_rate, num_channels)
...
freqs, mags = Utilities.compute_spectrum(tone, sample_rate, min_freq=10, max_freq=10000)
...
plt.title(f"Pure Tone ({frequency} Hz) Spectrum")
plt.xlabel("Frequency (Hz)")
plt.ylabel("Magnitude")
plt.grid(True)

# Save frequency spectrum plot
save_path = f"{project_path}/my_tone_frequency_spectrum.png"

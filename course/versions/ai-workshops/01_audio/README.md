...
Run **one** of these at a time. Wait for each to finish before running the next.

**Step 1 — create the question WAV (00):**

```bash
cd ~/NoBlackBoxes/LastBlackBox/course/versions/ai-workshops/01_audio/_resources/python
python 00_tts_make_question_audio.py
```

**Step 2 — transcribe to text (01):**
...
**Step 3 — get the robot reply and WAV (02):**

...
svg_path = layout_path + "/layout_new.svg"
...
def draw_box(file, name, x, y, width, height):
    ...
    box_tag = "\t<rect class=\"box\" id=\"{0}\" transform=\"scale(1,1) translate(1, 1)\" x=\"{1:2f}\" y=\"{2:2f}\" height=\"{3}\" width=\"{4}\" style=\"fill:#{5};{6}\"/>\n".format(box_id, x, y, width, height, box_fill, box_style)
    file.write("<g id=\"{0}\">\n".format(name))
    file.write(box_tag)
    file.write(text_tag)
    file.write("</g>\n")
...
svg_header = "<svg width=\"100mm\" height=\"100mm\" viewBox=\"0 0 100 100\" version=\"1.1\" id=\"logo\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:svg=\"http://www.w3.org/2000/svg\">\n"

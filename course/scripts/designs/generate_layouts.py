...
# LBB
# ---
layout = Layout.Layout("LBB", 4, 7, Config.box_names, 13.0, 0.125, 1.25, "#000000", "#FFFFFF", 1.75, True, True)
...
# Bootcamp
# --------
layout = Layout.Layout("Bootcamp", 3, 7, Config.bootcamp_box_names, 13.0, 0.125, 1.25, "#000000", "#FFFFFF", 1.75, True, True)
...
# Build a Brain
# -------------
layout = Layout.Layout("Build a Brain", 2, 4, Config.buildabrain_box_names, 13.0, 0.125, 1.25, "#000000", "#FFFFFF", 1.75, True, True)
...
# Own Phone
# ---------
layout = Layout.Layout("Own Phone", 3, 3, Config.ownphone_box_names, 13.0, 0.125, 1.25, "#000000", "#FFFFFF", 1.75, True, True)

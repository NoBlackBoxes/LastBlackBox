...
# Set frontend folder
front_path = LBBROOT + '/repo/site/front'
...
# Copy index.html
ret = subprocess.call(["cp", front_path + "/html/index.html", site_path + "/"])

# Copy style.css
ret = subprocess.call(["cp", front_path + "/css/style.css", site_path + "/"])

# Sync html pages to site

# Load header
header_path = front_path + '/html/header.html'
file = open(header_path,"r")
header_text = file.read()
file.close()

# Load footer
footer_path = front_path + '/html/footer.html'
